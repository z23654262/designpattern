 ...
 * @description 基于Javassist的动态代理-----在使用时需要事先创建好需要代理对象
 * @date 2019/4/14 14:20
 */
public class ProductDaoJavassistProxy {
    //真实需要代理的对象
    ...
    public ProductDao getProxy() throws Exception{
        //代理工厂
        ProxyFactory proxyFactory = new ProxyFactory();
        //设置需要创建子类的父类
        proxyFactory.setSuperclass(productDao.getClass());
        /*
        ...
        // 通过字节码技术动态创建子类实例
        return (ProductDao) proxyFactory.createClass().newInstance();
    }
}
